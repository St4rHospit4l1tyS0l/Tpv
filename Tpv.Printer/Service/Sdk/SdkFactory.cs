    ...
    public class SdkFactory
    {
            ...
            where TType : TInterface, new()
        {
            ...
            if ((instance == null)
                ...
                && MainWindowShown)
            {
                throw new Exception("Invalid license for this mode operation");
            }
        ...
        public static IAtgCashDrawer GetIatgCashDrawerInstance()
        {
            return GetInterfaceInstance<IAtgCashDrawer, CARadApiClass>(RAD_API_LICENSE);
        }

        public static IAtgGetCheckData GetIatgGetCheckDataInstance()
        {
            return GetInterfaceInstance<IAtgGetCheckData, CARadApiClass>(RAD_API_LICENSE);
        }
        ...
        internal static IARadTableTransfer GetIaRadTableTransfer()
        {
            return GetInterfaceInstance<IARadTableTransfer, CARadApiClass>(RAD_API_LICENSE);
        }
        ...
        public static IARadObjectAttribute GetIaRadObjectAttributeInstance()
        {
            return GetInterfaceInstance<IARadObjectAttribute, CARadApiClass>(RAD_API_LICENSE);
        }

        public static IARadIberFuncs25 GetIaRadIberFuncs25Instance()
        {
            return GetInterfaceInstance<IARadIberFuncs25, CARadApiClass>(RAD_API_LICENSE);
        }

        internal static IAtgIberHelper GetIatgIberHelperInstance()
        {
            return GetInterfaceInstance<IAtgIberHelper, CARadApiClass>(RAD_API_LICENSE);
        }
        public static IAtgAlohaBusinessObjects GetAtgObjects()
        {
            return GetInterfaceInstance<IAtgAlohaBusinessObjects, CARadApiClass>(RAD_API_LICENSE);
        }

        public static IAtgAlohaBusinessObjects2 GetAtgBuinessObjects2()
        {
            return GetInterfaceInstance<IAtgAlohaBusinessObjects2, CARadApiClass>(RAD_API_LICENSE);
        }

        public static IAtgGetCheckData GetAtgGetSeatDataObject()
        {
            return GetInterfaceInstance<IAtgGetCheckData, CARadApiClass>(RAD_API_LICENSE);
        }
